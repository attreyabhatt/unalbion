...
# TIER_POTION_ENCHANT_0 = artifact (if any) + ingredients
# Only base enchantment (0) is stored. Enchanted versions are calculated in JS
...
potion_recipes = {
    ...
    "T6_BERSERK_0": [("t6werewolf", 1), ("foxglove", 48), ("agaric", 24), ("potato_schnapps", 12)],
    "T6_POISON_0": [("foxglove", 24), ("teasel", 12), ("comfrey", 12), ("sheep_milk", 6)],
    "T6_ENERGY_0": [("foxglove", 72), ("sheep_milk", 18), ("potato_schnapps", 18)],
    "T6_GATHERING_0": [("t6runestone", 1), ("foxglove", 24), ("sheep_butter", 48), ("teasel", 12)],
    "T6_HEALING_0": [("foxglove", 72), ("potato_schnapps", 18), ("goose_eggs", 18)],
    "T6_HELLFIRE_0": [("t6imp", 1), ("foxglove", 24), ("sheep_milk", 48), ("hen_eggs", 12)],
    "T6_TORNADO_0": [("t6dawn", 1), ("foxglove", 48), ("teasel", 24), ("hen_eggs", 12)],
    ...
    "T8_BERSERK_0": [("t8werewolf", 1), ("yarrow", 144), ("comfrey", 72), ("potato_schnapps", 72), ("corn_hooch", 36), ("pumpkin_moonshine", 36)],
    ...
    "T8_GATHERING_0": [("t8runestone", 1), ("yarrow", 72), ("cow_butter", 144), ("mullein", 72), ("foxglove", 36), ("pumpkin_moonshine", 36)],
    "T8_HELLFIRE_0": [("t8imp", 1), ("yarrow", 72), ("cow_milk", 144), ("mullein", 72), ("goose_eggs", 36), ("pumpkin_moonshine", 36)],
    "T8_TORNADO_0": [("t8dawn", 1), ("yarrow", 144), ("mullein", 72), ("corn_hooch", 72), ("goose_egg", 36), ("pumpkin_moonshine", 36)],
}
